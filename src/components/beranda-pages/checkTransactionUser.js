                        ...
                        <Row style={{fontSize: 14, background: x }} className="my-0 dropdrop2    ">
                            ...
                            <Col md={1} xs={1} className=' border-bottom border-light'>
                                <Dropdown>
                                    ...
                                    >
                                        <Dropdown.Item className="text-success" onClick={() => this.handleChange(customer.User.id)}>
                ...
                <p>history transaksi : </p>
            {
                FIND.map( (history, index ) => {
                        return <Row key={index}>
                            ...
                            <Col>
                                code transaction : {history.attach.substr(-9)}
                            </Col>
...
export default connect(mapStateToProps, { checkTransaction, findTransactionUser  })(FindListTransactionsUser);
